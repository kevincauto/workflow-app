...
export function TicketSelector({
  ...
  return (
    <div className="space-y-4">
      <div className="rounded-[28px] border border-white/12 bg-slate-950/45 p-4">
        ...
        <div className="relative">
          <button
            ...
            className="min-h-14 w-full rounded-2xl border border-white/15 bg-[linear-gradient(180deg,rgba(15,23,42,0.84),rgba(15,23,42,0.62))] px-4 py-3 text-left shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] outline-none transition hover:border-cyan-200/40 focus:border-cyan-300 focus:ring-2 focus:ring-cyan-300/30 disabled:cursor-not-allowed disabled:opacity-60"
